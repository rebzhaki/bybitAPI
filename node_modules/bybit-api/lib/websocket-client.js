...
class WebsocketClient extends events_1.EventEmitter {
    ...
    subscribeV5(wsTopics, category, isPrivateTopic) {
        ...
        topics.forEach((topic) => {
            const wsKey = util_1.getWsKeyForTopic(this.options.market, topic, isPrivateTopic, category);
    ...
    subscribe(wsTopics, isPrivateTopic) {
        ...
        if (this.options.market === 'v5') {
            topics.forEach((topic) => {
                if (!util_1.isPrivateWsTopic(topic)) {
    ...
    connect(wsKey) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const url = util_1.getWsUrl(wsKey, this.options.wsUrl, this.isTestnet());
    ...
    requestSubscribeTopics(wsKey, topics) {
        ...
        const maxTopicsPerEvent = util_1.getMaxTopicsPerSubscribeEvent(this.options.market, wsKey);
